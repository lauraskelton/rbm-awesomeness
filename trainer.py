...
class MomentumAETrainer(AETrainer):
	def __init__(self, model, inputs, mask=None, batch_size=64, momentum=0.9):
		AETrainer.__init__(self, model, inputs, mask, batch_size)
